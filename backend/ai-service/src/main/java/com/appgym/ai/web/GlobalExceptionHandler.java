...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleAnthropicError(AnthropicServiceException ex, HttpServletRequest req) {
        return build(HttpStatus.BAD_GATEWAY, "El asistente de IA no esta disponible en este momento.", req);
    }
