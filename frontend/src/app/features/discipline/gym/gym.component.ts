...
const SUGGESTED_ROUTINES: Routine[] = [
  {
    title: 'Full body para empezar',
    description: '3 series x 12 repeticiones',
    detail: 'Sentadilla · Press banca · Remo con barra',
  },
  {
    title: 'Fuerza tren superior',
    description: '4 series x 8 repeticiones',
    detail: 'Press militar · Dominadas asistidas · Curl de bíceps',
  },
  {
    title: 'Cardio + core',
    description: '20 minutos',
    detail: 'HIIT en cinta · Plancha 3x1 min · Elevaciones de piernas',
  },
];
...
export class GymComponent implements OnInit {
  ...
  readonly heroImage =
    'https://images.pexels.com/photos/29224211/pexels-photo-29224211.jpeg?auto=compress&cs=tinysrgb&w=1600';
  readonly routines = SUGGESTED_ROUTINES;
